...
<svelte:head>
	<title>{$status?.theme_page_title || '0x File'}</title>

	<!-- Mobile App Meta Tags -->
	<meta name="application-name" content={$status?.theme_page_title || '0x File'} />
	<meta name="apple-mobile-web-app-title" content={$status?.theme_page_title || '0x File'} />
	<meta name="apple-mobile-web-app-capable" content="yes" />
	<meta name="mobile-web-app-capable" content="yes" />
	<meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />

	<!-- Favicon Implementation -->
	<link rel="icon" type="image/x-icon" href={$status?.theme_favicon || '/0x-file.ico'} />
	...
	<meta property="og:title" content={$status?.theme_page_title || '0x File'} />
	<meta property="og:description" content="Secure, temporary file and text sharing" />
	<meta property="og:image" content="/favicon.png" />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://zeroxfile.xyz" />
	<meta property="og:site_name" content="0x File" />
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:title" content={$status?.theme_page_title || '0x File'} />
