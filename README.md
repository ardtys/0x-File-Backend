...
*Share files and text that vanish after being viewed. No traces, no storage, just temporary sharing.*

[![Live Demo](https://img.shields.io/badge/demo-zeroxfile.xyz-blue?style=for-the-badge)](https://zeroxfile.xyz)
...
[**Live Demo**](https://zeroxfile.xyz) · [**Documentation**](#-documentation) · [**Deploy Now**](#-deployment)
...
In a world where **data breaches** and **privacy concerns** are everywhere, 0x File offers a simple solution: **temporary, encrypted sharing** that leaves no traces.
...
0x File includes a powerful CLI for automation and scripting:

```bash
# Install CLI
npm install -g 0xfile

# Upload text
echo "Secret message" | 0xfile upload

# Upload file
0xfile upload ./document.pdf --views 1

# Download
0xfile download <note-id> <password>
```
...
git clone https://github.com/ardtys/0x-File
cd 0xfile
...
- 🐛 **Issues**: [GitHub Issues](https://github.com/ardtys/0x-File/issues)
- 💬 **Discussions**: [GitHub Discussions](https://github.com/ardtys/0x-File/discussions)
- 📧 **Email**: support@0x-File.xyz
...
*0x File - Because some things should disappear.*

[![Star on GitHub](https://img.shields.io/github/stars/ardtys/0x-File?style=social)](https://github.com/ardtys/0x-File)
